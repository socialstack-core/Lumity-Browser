...
PageWithSidebar.propTypes = {
	...
	// Also the special id type which can be used to select some other piece of content (by pageWithSidebar name), like this:
...
PageWithSidebar.icon='align-center'; // fontawesome icon
*/